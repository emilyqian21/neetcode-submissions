class Solution:
    def maxCoins(self, nums: List[int]) -> int:
        ...
        def dfs(l,r):
            ...
            # base case
            if l > r:
                return 0 # 没有 balloon 可以戳 → 获得 0 coins。
            if (l,r) in memo:
                return memo[(l,r)]
            ...
            for i in range(l, r + 1): # 每个i都可能是最后一个被戳破的气球
                left_coins = dfs(l, i - 1) # max coins from bursting all in nums[l: i]
                right_coins = dfs(i + 1, r) # max coins from bursting all in numsp[i + 1, r + 1]
            ...
            memo[(l,r)] = max_coins # for loop结束了，尝试过所有i了，所以把最好的答案记在memo里
